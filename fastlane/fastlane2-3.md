...
![Main screen with Facilities, Edquipment, and Other Resources highlighted]({{ site.baseurl }}/fastlane/images/32-MainScreen-facilities-Equip-and-other-resources.jpg)
...
![File upload screen for Facilities, Equipment, and Other Resources]({{ site.baseurl }}/fastlane/images/32-facilities-Equip-and-other-resources.jpg)

## Project Summary

Follow the instructions on the below screen, then click **"Upload File"** to upload document. Click **"Go Back"** until you return to the "Form Preparation" screen.

![Main screen with Project Summary highlighted]({{ site.baseurl }}/fastlane/images/33-MainScreen-project-summary.jpg)
...
![Project Summary textboxes, with checkbox for supplementary document option at upper left corner highlighted]({{ site.baseurl }}/fastlane/images/33-project-summary.jpg)
...
![Main screen with Project Description highlighted]({{ site.baseurl }}/fastlane/images/34-MainScreen-project-description.jpg)
...
![Project Description file upload screen]({{ site.baseurl }}/fastlane/images/34-project-description.jpg)
...
![Main screen with Biographical Sketch highlighted]({{ site.baseurl }}/fastlane/images/35-MainScreen-bio-sketch.jpg)
...
![List of personnel assigned to proposal]({{ site.baseurl }}/fastlane/images/35-bio-sketch.jpg)
...
![Bio Sketch file upload intstructions and field]({{ site.baseurl }}/fastlane/images/36-bio-sketch2.jpg)
...
![Main screen with Current and Pending Support highlighted]({{ site.baseurl }}/fastlane/images/37-MainScreen-current-and-pending-support.jpg)
...
![Current and Pending Support table for existing forms and option to add new ones]({{ site.baseurl }}/fastlane/images/37-current-and-pending-support.jpg)

Fill in all the required information, click **"Save Text"** and then **"Go Back"** until you return to the "Form Preparation" screen.

![Current and Pending Support form creation screen]({{ site.baseurl }}/fastlane/images/38-current-and-pending-support2.jpg)

Follow the instructions on the below screen, then click **"Upload File"** to upload the document. Click **"Go Back"** until you return to the "Form Preparation" screen.

![Current and Pending Support file upload screen]({{ site.baseurl }}/fastlane/images/39-current-and-pending-support3.jpg)
...
![Main screen with Data Management Plan highlighted]({{ site.baseurl }}/fastlane/images/40-MainScreen-data-management.jpg)

Follow the instructions on the below screen, then click **"Upload File"** to upload the document. Click **"Go Back"** until you return to the "Form Preparation" screen.

![Data Management file upload screen]({{ site.baseurl }}/fastlane/images/40-data-management.jpg)
...
![Main screen with Mentoring Plan highlighted]({{ site.baseurl }}/fastlane/images/41-MainScreen-mentoring-plan.jpg)

Follow the instructions on the below screen, then click **"Upload File"** to upload the document. Click **"Go Back"** until you return to the "Form Preparation" screen.

![Mentoring Plan file upload screen]({{ site.baseurl }}/fastlane/images/41-mentoring-plan.jpg)

## Other Supplementary Docs

19. Click on the **"Go"** button to the left of **"Other Supplementary Docs":**

![Main screen with Other Supplementary Docs highlighted]({{ site.baseurl }}/fastlane/images/42-MainScreen-other-supplementary-docs.jpg)
...
![Other Supplementary Docs text box]({{ site.baseurl }}/fastlane/images/42-other-supplementary-docs.jpg)
...
![Other Supplementary Docs file upload screen]({{ site.baseurl }}/fastlane/images/43-other-supplementary-docs2.jpg)
