...
![Cover sheet selection]({{ site.baseurl }}/fastlane/images/6-cover-sheet.jpg)
...
![Cover sheet component page]({{ site.baseurl }}/fastlane/images/7-cover-sheet-components.jpg)
...
![Institution for this proposal]({{ site.baseurl }}/fastlane/images/8-Institution-for-this-proposal.jpg)
...
![Save primary place of performance button]({{ site.baseurl }}/fastlane/images/9-add.change-primary-place-of-performance.jpg)
...
![Program announcement/solicitation/program descriptions button]({{ site.baseurl }}/fastlane/images/10a-remainder-of--the-cover-sheet.jpg)

The third Cover Sheet **"GO"** Button is **"NSF Unit Consideration"**.

![NSF unit consideration button]({{ site.baseurl }}/fastlane/images/10a-remainder-of--the-cover-sheet.jpg)
...
![Remainder of the cover sheet button]({{ site.baseurl }}/fastlane/images/10a-remainder-of--the-cover-sheet.jpg)
...
![Title of proposed project field]({{ site.baseurl }}/fastlane/images/11a-title-of-proposed-project--and-budget.duration.jpg)
...
![Budget information fields]({{ site.baseurl }}/fastlane/images/11b-title-of-proposed-project--and-budget.duration.jpg)
...
![Announcements and Consideration fields]({{ site.baseurl }}/fastlane/images/12a-announcement-and-consideration-information-AND-PI-information.jpg)
Principal Investigator fields
![Announcements and Consideration fields 2]({{ site.baseurl }}/fastlane/images/12b-announcement-and-consideration-information-AND-PI-information.jpg)

**"Previous NSF Award":** **Do not check the box.**

_Preliminary proposals are not accepted by the SBIR/STTR Program._

![Preliminary proposals checkbox]({{ site.baseurl }}/fastlane/images/13a-Previous-NSF-award-AND-Other-federal-agencies.jpg)
...
![Other federal agencies boxes]({{ site.baseurl }}/fastlane/images/13b-Previous-NSF-award-AND-Other-federal-agencies.jpg)
...
![Awardee Organization Information options]({{ site.baseurl }}/fastlane/images/14-awardee-organization-info-AND-Primary-Place-of-Performance.jpg)
...
![Other information options]({{ site.baseurl }}/fastlane/images/15-other-information.jpg)

**"Funding Mechanism:** Select "Research - other than RAPID or EAGER"

![Funding Mechanism dropdown]({{ site.baseurl }}/fastlane/images/16-funding-mechanism.jpg)
...
![Collaborative status selection]({{ site.baseurl }}/fastlane/images/17-collaborative-status.jpg)
...
![Research topic dropdown]({{ site.baseurl }}/fastlane/images/18-Small-business-innovation-research-subtopic.jpg)

**"The Small Business Concern Certifies":** Answer all of the following questions.

![Small business concern options]({{ site.baseurl }}/fastlane/images/19-small-business-concern.jpg)
...
![Company Officer information fields]({{ site.baseurl }}/fastlane/images/20-company-officer-information.jpg)

![Proprietary notice field]({{ site.baseurl }}/fastlane/images/21-proprietary-notice.jpg)
...
![Debarment and Suspension Certification questions]({{ site.baseurl }}/fastlane/images/22-debarment-and-suspension-cert.jpg)

![Authorized representative alert: AOR information will be added when proposal is signed electronically by AOR]({{ site.baseurl }}/fastlane/images/23-authorized-representative.jpg)

## Add/Delete Non Co-PI Personnel

Click on the **"Go"** button to the left of **"Add/Delete Non Co-PI Senior Personnel":**

![Main screen]({{ site.baseurl }}/fastlane/images/24-MainScreen-add-delete-non-copi-senior-personnel.jpg)
...
![Adding non co-pi senior person form]({{ site.baseurl }}/fastlane/images/24-add-delete-non-copi-senior-personnel.jpg)
