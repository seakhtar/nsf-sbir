...
section_image_caption: |
   Jane's Carousel in Brooklyn Bridge Park (artists: Sydney Shea & Carol Hsiung for drawing, and Joel Artista for mural) made possible by [Mental Canvas LLC]({{ base.url }}/portfolio/details/?company=mental-canvas-llc#mental-canvas-llc), the first to make hand drawings 3D.
---
{% comment %}
